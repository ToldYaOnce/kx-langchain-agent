...
export class AgentEventFactory {
  static createGoalActivated(
    ...
    priority: 'critical' | 'high' | 'medium' | 'low',
    order: number,
    activationReason: { trigger: string; details: string },
    fieldsToCapture?: string[]
  ): GoalActivatedEvent {
    return {
      channelId,
      ...
      order,
      fieldsToCapture,
      activationReason: activationReason as any,
    };
  }

  static createGoalCompleted(
    channelId: string,
    tenantId: string,
    goalId: string,
    goalName: string,
  ...
  static createDataCaptured(
    ...
    return {
      ...
      fieldValue,
      goalId,
      dataType: typeof fieldValue as any,
      validated,
      validationErrors,
    };
  }

  static createWorkflowStateUpdated(
    channelId: string,
    tenantId: string,
    activeGoals: string[],
    completedGoals: string[],
