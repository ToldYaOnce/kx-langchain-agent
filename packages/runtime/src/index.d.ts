...
export type { PersonaItem, PersonaConfig, CreatePersonaItem, UpdatePersonaItem, QueryPersonasByTenantParams, Timestamp, ULID, TenantId, EmailLowercase, PhoneE164, PersonaStatus, CompanyInfo as DynamoCompanyInfo, PersonalityConfig, ResponseGuidelines, GreetingConfig, IntentTrigger as DynamoIntentTrigger, IntentCapturing as DynamoIntentCapturing, GoalConfiguration as DynamoGoalConfiguration, GoalDefinition, ActionTagConfig as DynamoActionTagConfig, ResponseChunking as DynamoResponseChunking } from './types/dynamodb-schemas.js';
...
export { PersonaService, type CompanyInfo } from './lib/persona-service.js';
...
export type { ConversationGoal, GoalConfiguration, ConversationGoalState } from './types/goals.js';
