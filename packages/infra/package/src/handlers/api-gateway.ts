...
/**
 * Response structure for API Gateway chat responses
 */
interface ChatResponse extends AgentResponse {
...
export async function handler(
  ...
  try {
    ...
    eventBridgeService.publishAgentReply(
      EventBridgeService.createAgentReplyEvent(
        requestBody.tenantId,
        DynamoDBService.createContactPK(requestBody.tenantId, emailLc),
